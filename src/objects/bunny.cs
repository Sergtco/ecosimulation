...
class Bunny : Animal
{
    ...
    public Bunny(Game1 game) : base(game)
    {
        speed = Vector2.Zero;
        chagePosition(1);
    }

    public Bunny(Game1 game, Vector2 position) : this(game)
    {
    ...
    {
        sheet = game.Content.Load<GridSheet>("sprites/bunny/MiniBunny");
        idleAnimation = new Animation(sheet, 0, 0.3f, 4, true);
        walkAnimation = new Animation(sheet, 1, 0.2f, 4, true);
        deadAnimation = new Animation(sheet, 3, 0.2f, 3, false);
    }
